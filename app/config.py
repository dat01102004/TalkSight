...
TTS_OUTPUT_DIR = os.getenv("TTS_OUTPUT_DIR", os.path.join(UPLOAD_DIR, "tts"))
TTS_DEFAULT_LANGUAGE = os.getenv("TTS_DEFAULT_LANGUAGE", "vi-VN")
TTS_DEFAULT_FEMALE_VOICE = os.getenv("TTS_DEFAULT_FEMALE_VOICE", "vi-VN-HoaiMyNeural")
TTS_DEFAULT_MALE_VOICE = os.getenv("TTS_DEFAULT_MALE_VOICE", "vi-VN-NamMinhNeural")
